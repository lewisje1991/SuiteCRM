...
class Account extends Company
{
    ...
    public function __construct()
    {
        ...
        if (!empty($_REQUEST['parent_id']) &&
            !empty($_REQUEST['parent_type']) &&
            $_REQUEST['parent_type'] == 'Emails'
    ...
    public function fill_in_additional_detail_fields()
    {
        ...
        if (empty($this->parent_name) && !empty($this->id)) {
            $query = "SELECT a1.name from accounts a1, accounts a2 
                      where a1.id = a2.parent_id and a2.id = '$this->id' and a1.deleted=0";
    ...
    */
    ...
    public function create_export_query($order_by, $where, $relate_link_join = '')
    {
        ...
        $query .= ' and email_addr_bean_rel.bean_module=\'Accounts\' ';
        $query .= ' and email_addr_bean_rel.deleted=0 and email_addr_bean_rel.primary_address=1 ';
